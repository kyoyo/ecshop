...
class GoodsAdmin(admin.ModelAdmin):
    search_fields = ['name']
    list_display = ['category', 'name', 'order_value','cost_price', 'price', 'count', 'status']
    list_display_links = ('name',)
    list_filter = ('category', 'status', 'is_abort',)
    fields = ('category', 'name','order_value', 'keywords', 'image', 'details', ('count', 'sales_count'),
...
class CategoryAdmin(admin.ModelAdmin):
    search_fields = ['name']
    list_display = ['name', 'sort', 'parent', 'is_root']
    fields = ('name','desc', 'sort', 'image', 'parent', 'is_root')
